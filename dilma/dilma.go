...
var (
	...
	frasesDilma = []string{
		...
		"Pois bem. Inventam uma história fantástica que tá na nuvem... É tá na nuvem. Sei lá que nuvem. Sabe eu não entendi muito bem essa história da nuvem. To aqui tentando apurar direitinho. Como é que uma coisa pode tá na nuvem. É muito simples estar na nuvem, ele não têm que provar. Que nuvem? Aonde tá a prova.",
	}
)
